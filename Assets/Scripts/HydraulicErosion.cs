...
public class HydraulicErosion
{
    ...
    public HydraulicErosion(int seed, int erosionRadius, float inertia, float sedimentCapacityFactor, float minSedimentCapacity, float erodeSpeed, float depositSpeed, float evaporateSpeed, float gravity, int maxDropletLifetime, float initialWaterVolume, float initialSpeed)
    {
        this.seed = seed;
