...
public static class MeshGenerator
{
    ...
    public static MeshData GenerateTerrainMesh(float[,] heightMap, float heightMultiplier, AnimationCurve _heightCurve, int levelOfDetail, bool useFlatShading)
    {
        ...
        float topleftZ = (meshSizeUnsimplified - 1) / 2f; //to center this
...
public class MeshData
{
    ...
    public MeshData(int verticesPerLine, bool useFlatShading)
    {
        ...
        borderVertices = new Vector3[verticesPerLine * 4 + 4]; //number of vertices on the border (thickness of 1) is mesh size*4 (sides) and + 4 on the corners
    ...
    Vector3 SurfaceNormalFromIndices(int indexA, int indexB, int indexC)
    {
        ...
        Vector3 sideAC = pointC - pointA; //wektory tworzymy
        return Vector3.Cross(sideAB, sideAC).normalized;// cross product jest prostopadły
