...
public class EndlessTerrain : MonoBehaviour
{
    ...
    void UpdateVisibleChunks()
    {
        ...
        //this loop is starting at the end and counts backwards bcs if the terrainchunk removes itself it would cause index errors when counting upwards
    ...
    public class TerrainChunk
    {
        ...
        public void UpdateCollisionMesh()
        {
            if (!hasSetCollider)
            {
                ...
                if (sqDstFromViewerToEdge < detailLevels[colliderLODIndex].sqrVisibleDstThreshold)
                {
